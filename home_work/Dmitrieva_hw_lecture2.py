...
while a not in mn:
    ...
    #print(ymp)
    print()
    print("Ваше число - ", ymp, ", верно?")
    print()
    b = input("Напишите Да или Нет: ")
    print()
    if b == "Да":
      print("Отлично!")
    elif b == "Нет":
      print("Всмысле? Почему?")
    else: print("...Мда. Вам уже ничего не поможет...")